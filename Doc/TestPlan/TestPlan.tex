...
\begin{enumerate}
	...
	Output: $R(f(V)) = R(f_1(V)) <op> R(f_2(V))$ by induction
	...
	Output: $R(f(V)) \neq R(f_1(V)) <op> R(f_2(V))$ by induction
	
	How test will be performed: Induction
	
	Note: This case should only apply to cases where there is a mixed interval 
	divisor for the division operator\\
