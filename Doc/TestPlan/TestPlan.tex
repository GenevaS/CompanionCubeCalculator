...
\ref{R_conditionfx} functional requirements and the associated data constraints 
from \ref{R_verifyinputs} are satisfied.
...
This test suite is designed to determine if the \ref{R_Calculate}, 
\ref{R_VerifyOutput}, and \ref{R_VerifyOutputConstraints} functional 
requirements.

\paragraph{Composition of Operators}
...
\begin{enumerate}
	...
	\item{test-parse\_simpleEquation}
