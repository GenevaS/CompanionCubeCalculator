...
sequence of continuous values \wss{Say set rather than sequence of
  continuous values} bounded by a minimum and maximum value. The
...
\begin{itemize}
	...
	This version \wss{The selected version} of Visual Studio allows developers to record a series of 
