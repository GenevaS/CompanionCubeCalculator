...
capabilities. Both languages have tools for unit testing which will be used 
extensively during the verification process. 

\todo{Look into static analysis tools, continuous integration, test/code 
coverage tools}
