...
\wss{You have multiple ACs mapping to the same modules.  I think this makes
  sense for the specific cases where it occurs, but you should highlight it in
  your discussion.  It violates the usual rule of one module, one secret.}
...
\wss{Looks like a great design to start with.  You may end up making some tweaks
  as you work on the MIS.}
