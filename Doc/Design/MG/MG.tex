...
decomposition of $f(V)$ will always follow BEDMAS rules.
...
\item [\refstepcounter{mnum} \mthemnum \label{mDC}:] Data Conversion Module
...
\multirow{5}{0.3\textwidth}{Behaviour-Hiding Module} & Control Flow Module & -\\
& User Input Module & -\\
& \multirow{2}{0.3\textwidth}{Data Conversion Module} & Equation Conversion 
Module \newline Interval Conversion Module \\
& Range Solver Module & - \\
& Output Module & - \\
\midrule

\multirow{2}{0.3\textwidth}{Software Decision Module} & Equation Data Structure 
Module & - \\
