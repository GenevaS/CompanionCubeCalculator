...
\item [\refstepcounter{mnum} \mthemnum \label{mP}:] Parsing Module
...
\\
& User Input Module & - \\
& \multirow{3}{0.29\textwidth}{Parsing Module} & 
...
\subsubsection{Parsing Module (\mref{mP})}
...
\rref{R_verifyinputs} & \mref{mCF}, \mref{mP}, \mref{mIC}, \mref{mEC}\\
\rref{R_conditionfx} & \mref{mCF}, \mref{mP}, \mref{mEC}, \mref{mRS}\\
