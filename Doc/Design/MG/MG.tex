...
implementation of the equation parse tree data structure.
...
calculation of $R(f(V))$ is defined based on the input data.
...
\item[\refstepcounter{ucnum} \uctheucnum \label{ucParsing}:] The parsing of 
$f(V)$ will always follow arithmetic operator precedence rules.
